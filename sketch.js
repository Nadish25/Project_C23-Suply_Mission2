...
var boxLeft,boxRight,boxBottom,boxBottomSprite;
...
function setup() {
	...
	boxLeft=createSprite(300,590,20,100,{isStatic:true});
	boxLeft.shapeColor=color(255,0,0);

	boxRight=createSprite(480,590,20,100,{isStatic:true});
	boxRight.shapeColor=color(255,0,0);
	

	boxBottom=createSprite(390,650,200,20, {isStatic:true} );
